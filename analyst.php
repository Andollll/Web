...
while($row = mysqli_fetch_array($result)){
  ...
  $list = $list."<li><a href=\"analyst.php?name={$row['id']}\">{$name}</a></li>";
}
/*
...
<td width='1800' height='100'>
  <?php
    ...
    //  $row = mysqli_fetch_array($result);
        ...
        echo "<h1 style = 'font-size :50px;' align=center>".$article['profile']."</h1>";
         echo "<h1 align=center>By  ".$article['name']."</h1>";
      }


else{
  echo "<h1 style = 'font-size :50px;' align=center>인사말";
}
